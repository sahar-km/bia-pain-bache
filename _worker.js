// @ts-nocheck
// <!-------  time is 2024-04-18 02:26:15 UTC -------!>
// @ts-ignore
...
const proxyIPs= ['ni.radiically.pro'];// OR USE const proxyIPs = ['cdn.xn--b6gac.eu.org', 'cdn-all.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org'];
